...
// Datos de siembra inicial (solo para poblar Supabase una vez).
// La app NO usa estos datos para renderizar: las secciones siempre
// se leen desde Supabase. Este archivo es el respaldo para el
// endpoint /api/seed si prefieres no ejecutar supabase/schema.sql.
export const seedSections: Section[] = [
  {
    id: 'seed-investigaciones',
